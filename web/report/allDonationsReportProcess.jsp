...
<%
    ...
    Integer departmetnId = null;
    try {
        departmetnId = Integer.parseInt(request.getParameter("departmentId"));
    } catch (Exception e) {
    }
    ...
    hm.put("P_organizationId", organizationId);
    hm.put("P_departmentId", departmetnId);
    ...
    JasperReport allDonationsReport = JasperCompileManager.compileReport(application.getRealPath("/WEB-INF/reports/AllDonations.jrxml"));
